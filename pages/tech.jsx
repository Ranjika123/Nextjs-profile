...
const tech = () => {
  const data = [
    ...
    },
    {
      ...
      desc: "An open-source web development framework providing React-based web applications,Also my favourite.",
      tag: "develop",
      bg: "bg-gray-900",
      text: "text-gray-50",
    },
    ...
    },
    {
      ...
      desc: "Platform to shawcase Developers projects to internet.",
      tag: "platform",
      bg: "bg-gray-900",
      text: "text-gray-100",
    },
      ...
      <main className="max-w-screen max-w-5xl mx-auto">
        <div className="pt-24 flex flex-col mx-auto">
          ...
          <p className="mt-8 font-normal lg:text-lg text-center md:w-[70%] mx-auto text-base md:text-[1.15rem] ">
            Just like any other Developers, I also spend more time searching and learning
            new technologies 😎
          </p>
        </div>
