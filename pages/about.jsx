...
export default function About() {
  ...
  return (
    <div className="px-10 sm:px-20 md:px-32 lg:mb-12 lg:px-60 mx-auto max-w-[75rem]">
      <Head>
        <title>about ✦ ranjika_neth</title>
        ...
        <div className=" mx-auto pt-16 -pb-10 max-w-7xl">
          ...
          <div className=" text-[0.92rem] md:text-base md:text-md lg:text-lg xl:text-xl mx-auto font-light dark:text-white text-gray-900 ">
            ...
            <p className="">
              ...
              <span className="text-red-700 font-bold">G Mail</span>{" "}
              <a
                onClick={() =>
                  navigator.clipboard.writeText("ranjikaneth2005@gmail.com")
                }
              ...
              <a
                href="https://www.instagram.com/ranjika_neth/"
                target="blank"
                rel="noopener noreferrer"
